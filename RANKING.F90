      DOUBLE PRECISION RANKS(2,14),MNAME,MOLDNM,ISTATS(2),IST
      DIMENSION RANKPT(14)
      DATA RANKS/'        ','INDUCTEE','        ',
...
30342 IRNK=14
      IIKK=IIKK+1
      READ(3'IIKK,ERR=30347)MNAME,POINTS,X1,X2,X3,X4,IRST
      IF(MNAME.EQ.MOLDNM)GO TO 30349
      MOLDNM=MNAME
30344 IF(POINTS.GE.RANKPT(IRNK))GO TO 30345
      IRNK=IRNK-1
      GO TO 30344
30345 IF(IRST.EQ.0)GO TO 30347
...
30346 FORMAT(2A8,' ',A8,' CURRENTLY HAS POINTS = ',F6.2,' GAME ',A8)
      GO TO 30342
30347 WRITE(6,30348)RANKS(1,IRNK),RANKS(2,IRNK),MNAME,POINTS
30348 FORMAT(2A8,' ',A8,' CURRENTLY HAS POINTS = ',F6.2)
      GO TO 30342
30349 STOP
      END
